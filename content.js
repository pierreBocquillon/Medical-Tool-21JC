;(async () => {
	...
	function addBlessures(blessures) {
		if (blessures === "VC") return // Cas spécial géré ailleurs ou ignoré pour le moment si pas de blessures VC
